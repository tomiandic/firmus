...
import { Button, useMediaQuery, Fade, Divider } from "@material-ui/core";
...
export default function Landing() {
  ...
  return loaderVisible ? (
    ...
    <div className={classes.landingContainer}>
      ...
      {!matches && (
        <svg className={classes.landingLogo} fill="#fff" viewBox="0 0 743 710.19">
          <path
      ...
      <div className={classes.loginDiv}>
        ...
        <p className={classes.landingSubTitle}>
          Pridruži se Firmusu i u par jednostavnih koraka čekaju te brzi poslovi u tvom džepu.
        </p>
        <Button onClick={openForm} color="primary" variant="contained" className={classes.landingBtn}>
